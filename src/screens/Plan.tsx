...
import { useAIOverlay } from '../components/AIChatOverlay';
...
export function PlanScreen() {
  ...
  const { open } = useAIOverlay();

  return (
    <Screen>
      <View style={styles.page} testID="screen-plan">
      ...
      <Pressable style={styles.aiFab} onPress={open}>
