...
export function FocusScreen({ navigation, route }: Props) {
  ...
  const progress = remainingSeconds / (focusMinutes * 60);
  ...
  return (
    <Screen>
      <View style={styles.page}>
        ...
        >
          <Ionicons name={soundEnabled ? 'volume-high' : 'volume-mute'} size={16} color={soundEnabled ? theme.colors.primary : theme.colors.textMuted} />
        ...
        <View style={styles.buttonRow}>
          ...
          <Pressable style={styles.primaryButton} onPress={() => setIsRunning((prev) => !prev)}>
            <Ionicons name={isRunning ? 'pause' : 'play'} size={20} color={theme.colors.bg} />
